...
# mamba install -c anaconda pandas numpy scikit-bio -y
# mamba install -c conda-forge imbalanced-learn scikit-learn catboost -y
...
tree = TreeNode.read('/scratch/tianche5/PhyCollar/PC_baseline/binary/tree.nwk')
