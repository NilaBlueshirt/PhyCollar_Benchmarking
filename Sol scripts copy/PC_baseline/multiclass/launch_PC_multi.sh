...
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: none ::: /scratch/tianche5/PhyCollar/PC_baseline/*/*/*.py > manifest_1
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: none ::: /scratch/tianche5/PhyCollar/PC_baseline/*/*.py > manifest_2
# cat manifest_1 manifest_2 > manifest
# Run the job array for sub_job 1:
# sbatch -a 1-1500 -c 16 launch_PC_multi.sh manifest
...
python PC_multi.py $trial_idx $model $pca $target_location
