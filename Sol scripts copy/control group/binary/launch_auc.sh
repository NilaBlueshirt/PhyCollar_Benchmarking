...
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: pca none ::: /scratch/tianche5/PhyCollar/binary/*/*/*.py > manifest_1
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: pca none ::: /scratch/tianche5/PhyCollar/binary/*/*.py > manifest_2
# cat manifest_1 manifest_2 > manifest
# Run the job array for sub_job 1:
# sbatch -a 1-1000 -c 16 launch_auc.sh manifest
...
python auc.py $trial_idx $model $pca $target_location
