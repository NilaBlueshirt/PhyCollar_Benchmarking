...
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: none ::: /scratch/tianche5/PhyCollar/PC/data/binary/*/*/*.py > manifest_1
# parallel -k echo {} ::: $(seq 1 50) ::: cat mlp rf svm lg ::: none ::: /scratch/tianche5/PhyCollar/PC/data/binary/*/*.py > manifest_2
