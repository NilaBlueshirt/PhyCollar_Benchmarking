...
# parallel -k echo {} ::: $(seq 1 50) ::: cat rf mlp svm lg ::: pca none ::: /scratch/tianche5/PhyCollar/multiclass/*/*/*.py > manifest_1
# parallel -k echo {} ::: $(seq 1 50) ::: cat rf mlp svm lg ::: pca none ::: /scratch/tianche5/PhyCollar/multiclass/*/*.py > manifest_2
# cat manifest_1 manifest_2 > manifest
# Run the job array:
# sbatch -a 1-3000 -c 16 launch_auc_multi.sh manifest
...
python auc_multi.py $trial_idx $model $pca $target_location